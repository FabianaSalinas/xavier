...
export default function Rastreio() {
  ...
  // ✅ HERO grande no início; diminui quando encontra
  const heroCompact = !!doc;

  // ✅ para rolar quando encontra
  ...
  const scrollToResult = () => {
    // dá um respiro por causa do header sticky
    const offset = 90;
  ...
  return (
    <main className="min-h-screen bg-slate-50">
      ...
      <section className="relative overflow-hidden">
        ...
        {/* ✅ aqui controla o tamanho da faixa azul */}
        <div
          className={`relative transition-all duration-500 ${
            heroCompact ? "min-h-[420px]" : "min-h-[88vh]"
          } flex items-center`}
        >
          <div className="relative w-full max-w-6xl mx-auto px-4 py-12 sm:py-14">
        ...
        {!doc ? (
          ...
          <div className="grid gap-6">
            ...
            <div className="bg-white rounded-3xl shadow-sm ring-1 ring-slate-200 overflow-hidden">
              ...
              {/* TRACKING FULL-WIDTH (sem lateral) */}
              {doc.LinkTracking && (
